...
class Navbar extends Component {
  ...
  Avatar() {
    if (IsLoggedIn)
      return (
        <div id="navAvatar">
          <Link to={"/u/" + USERID}><img src={"https://a.gigamons.de/" + USERID} alt="Your user profile." /></Link>
        </div>
      )
    else
      return (
        <div id="navAvatar">
          <img src="https://a.gigamons.de/0" width="56" height="56" alt="Default osu profile." />
        </div>
      )
  }
  Messages() {
